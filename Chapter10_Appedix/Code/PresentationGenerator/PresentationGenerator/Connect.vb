...
#Region "Command Bar Buttons' Code"
  ...
  Private Sub cbbSaveBravoPPT_Click(ByVal Ctrl As Microsoft.Office.Core.CommandBarButton, _
    ...
    With sfdFile
      ...
      .Filter = "PowerPoint files (*.ppt)|*.pp|All files (*.*)|*.*"
      .FilterIndex = 1 'Set .ppt as default type
      .OverwritePrompt = True
      .RestoreDirectory = True 'Restore the Initial Directory settings back to the user's default.
