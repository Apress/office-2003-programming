...
#Region " Windows Form Designer generated code "
    ...
    " the Timesheet System.  You must specify a ""Monday"" for the week start."
    ...
    Me.chkUpload.Text = "Upload Hours to Timesheet System"
    '
    'cmdCancel
    '
    ...
    Me.Text = "Upload Hours to Timesheet System?"
...
#Region "Event Methods"
  Private Sub SaveDialog_Load(ByVal sender As System.Object, _
  ...
  Private Sub dpStartDate_Validating(ByVal sender As Object, _
    ByVal e As System.ComponentModel.CancelEventArgs) _
    Handles dpStartDate.Validating

    If Not Me.dpStartDate.Value.DayOfWeek = DayOfWeek.Monday Then
      MsgBox("You must specify a monday as the start of the week.", MsgBoxStyle.Exclamation, "Wrong Day of Week")
      e.Cancel = True
    End If
