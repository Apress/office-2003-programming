...
#End Region
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As _
    ...
    If EventIssueObj Is Nothing Then
      Page.RegisterStartupScript("error_script", "<SCRIPT language=" & _
        "javascript>alert('The Tracking ID provided could not be " & _
        "located. Please contact a customer service representative " & _
    ...
    If Tasks.Count > 0 Then
      If CompletedTasks = Tasks.Count Then
        Me.lbl_CurrentStatus_Value.Text = _
          "Resolved (All tasks have been completed)"
      Else
        Me.lbl_CurrentStatus_Value.Text = "In Progress (" & _
        CompletedTasks & " of " & Tasks.Count & " tasks complete)"
      End If
    Else
      Me.lbl_CurrentStatus_Value.Text = _
        "Resolved (There were no tasks to complete)"
    End If
  ...
  Private Sub repTasks_ItemDataBound(ByVal sender As Object, ByVal e As _
    System.Web.UI.WebControls.RepeaterItemEventArgs) _
    Handles repTasks.ItemDataBound
